...
void main() {
  ...
  setUp(() async {
    ...
    final encrption = EncryptionService(Encrypter(AES(Key.fromLength(32))));
    await createDB(r, connection!);
    sut = MessageService(r, connection!, encrption);
  });
...
//dummy data
  ...
  test('message sent succesfully', () async {
  ...
  test('successfully subscribe and receive messages', () async {
    final contents = 'this is a test message';
  ...
  test('successfully subscribe and receive new messages', () async {
    ...
    Message secondmessage = Message(
        ...
        to: user2.id,
        timestamp: DateTime.now(),
        contents: 'this is the second test message');
